...
<div class="line-hub-profile-section">
    <h2>
        ...
        <?php esc_html_e('LINE Account Binding', 'buygo-hub-for-line'); ?>
    </h2>
    ...
    <div class="line-hub-binding-card">
        <?php if ($binding && !empty($binding->line_uid)) : ?>
            ...
            $display_name = !empty($binding->display_name) ? $binding->display_name : __('Unknown', 'buygo-hub-for-line');
                ...
                <div class="line-hub-binding-details">
                    ...
                    <?php if (!empty($linked_at)) : ?>
                        <div class="line-hub-binding-date">
                            ...
                            printf(esc_html__('Linked on: %s', 'buygo-hub-for-line'), esc_html($linked_at));
                            ?>
                        </div>
                    <?php endif; ?>
                </div>
            ...
            <div class="line-hub-binding-actions">
                <button type="button" class="line-hub-btn line-hub-btn-unbind" id="lineHubUnbindBtn"
                    ...
                    <?php esc_html_e('Unlink', 'buygo-hub-for-line'); ?>
                </button>
            </div>
        ...
        <?php elseif ($has_login_configured) : ?>
            <div class="line-hub-unbound-notice">
                ...
                <?php esc_html_e('LINE account is not linked. Link your account to receive order notifications and shipping updates.', 'buygo-hub-for-line'); ?>
            </div>
            ...
            <?php if (!empty($bind_url)) : ?>
                <div class="line-hub-binding-actions">
                    <a href="<?php echo esc_url($bind_url); ?>" class="line-hub-btn line-hub-btn-bind">
                        ...
                        <?php esc_html_e('Link LINE Account', 'buygo-hub-for-line'); ?>
                    </a>
                </div>
            <?php endif; ?>

        <?php else : ?>
            <p style="color:#6b7280;margin:0;"><?php esc_html_e('LINE Login is not configured. Please contact the administrator.', 'buygo-hub-for-line'); ?></p>
        <?php endif; ?>
    </div>
</div>
