...
<div class="lh-fc-binding" id="lineHubFcBinding">
        ...
        <div class="lh-fc-binding-card">
            ...
            <div class="lh-fc-details">
                ...
                <?php if (!empty($linked_at)) : ?>
                    ...
                    <div class="lh-fc-date"><?php printf(esc_html__('Linked on: %s', 'buygo-hub-for-line'), esc_html($linked_at)); ?></div>
                <?php endif; ?>
            </div>
        </div>
    ...
    <?php else : ?>
        <div class="lh-fc-unbound">
            ...
            <?php esc_html_e('Link your LINE account to receive order notifications and shipping updates.', 'buygo-hub-for-line'); ?>
        </div>
