...
3. 立即重新載入頁面
4. 確認新文字立即顯示（不是舊值）
5. 如果仍顯示舊值，檢查 transient 快取是否被正確清除
...
- VERIFY-05: PASS/FAIL + 說明
  ...
  <done>5 個 REST API 端點全部測試通過，設定儲存和快取清除正常運作</done>
</task>

<task type="checkpoint:human-verify" gate="blocking">
  <name>Task 2: 用戶確認驗證結果</name>
  <what-built>
Phase 8 所有修復和驗證已完成：
...
3. 如果有任何 FAIL，討論是否需要追加修復 Plan
  </how-to-verify>
  <resume-signal>輸入 "approved" 確認所有驗證通過，或描述需要修正的問題</resume-signal>
</task>
